<script lang="ts">
  ...
  import { currentTab, showToast, readOnlyMode as readOnlyStore } from "../stores/session";
    ...
    {#if step === 0}
      ...
      <div class="step-card">
        ...
        <div class="actions-footer">
          <button class="btn-primary" onclick={triggerFileSelect} disabled={readOnlyMode}>
            {readOnlyMode ? "Importacao bloqueada" : "Selecionar Arquivo CSV"}
          </button>
        </div>
      </div>
    {:else if step === 1}
